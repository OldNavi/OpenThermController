  ...
  void loop()
  {
    ...
    if (new_ts - ts > 1000)
    {
      ...
      if (responseStatus == OpenThermResponseStatus::SUCCESS)
      {
        ...
        vars.isFlameOn.value = ot.isFlameOn(statusResponse);
        vars.isFault.value = ot.isFault(statusResponse);
        vars.isDiagnostic.value = ot.isDiagnostic(statusResponse);
      }
